...
//List of words that will be excluded from the count.
...
//highlight the words of the search
function performMark() {
    ...
    //find all the marked words
    let spans = document.querySelectorAll('mark');
    
    
    //outerHTML is with the tags included, so the for loop below turns <mark>Alice</mark>, into "Alice".
    for(var i = 0; i < spans.length; i++) {
        spans[i].outerHTML = spans[i].innerHTML;
    }

    //the "gi" here means g = globally search, and i = case insensitive.
